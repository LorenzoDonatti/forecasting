...
env = "local"
pipeline_name = "data_manipulation"
...
with DAG(
    ...
    tasks["changetype"] >> tasks["mergedata"]

    tasks["removeless24"] >> tasks["mergedata"]

    tasks["mergedata"] >> tasks["addfeatures"]
